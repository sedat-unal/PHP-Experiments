                            ...
                            <div class="card-body">
                                ...
                                if($_POST)
                                {
                                    ...
                                    $update = $conn->prepare("UPDATE clients SET
                                        ...
                                        client_vkn      = :vkn,
                                        client_lang     = :lang WHERE client_id = :id");
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="lang" class="form-control" id="exampleFormControlSelect1">
                                                <option <?php echo $vRow["client_lang"] == "tr" ? "selected" : null;  ?>  value="tr">Türkçe</option>
                                                <option <?php echo $vRow["client_lang"] == "en" ? "selected" : null;  ?> value="en">İngilizce</option>
                                            </select>
                                        </div>
                                    </div>
