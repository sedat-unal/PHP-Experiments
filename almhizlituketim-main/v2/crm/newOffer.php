                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                ...
                                <a href="<?= $site_link ?>offers.php">Teklif Oluştur</a>
                    ...
                    <form method="POST" id="offerForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label for="inputState">Firma</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label for="inputAddress">Teklifin Tarih Aralığı</label>

                                <input type="text" name="simple-date-range-picker-callback" class="form-control" required="">

                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="inputState">Para Birimi</label>
                                <select name="paraBirimi" id="paraBirimi" class="form-control" required="">
                                ...
                                <div data-repeater-item>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            $getUrun = $conn->prepare("SELECT * FROM offeritems ORDER BY id DESC");
                        ...
                        <button style="margin-top:30px" type="submit" class="btn btn-primary" onclick="window.location.href='offers.php'">Kaydet ve Teklifi Görüntüle</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="simple-date-range-picker-callback"]').daterangepicker({
                ...
                swal("Tarih Aralığı Ayarlanmıştır", start.format('DD-MM-YYYY') + ' ile ' + end.format('DD-MM-YYYY') + ' arası', "success")
