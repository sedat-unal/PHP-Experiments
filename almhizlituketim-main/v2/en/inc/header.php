          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                <a class="dropdown-item" href="products.php?product=hygiene">Hygiene Group</a>
                <a class="dropdown-item" href="products.php?product=food">Food Group</a>
                <a class="dropdown-item" href="products.php?product=printing">Flexo Printing Group</a>
                <a class="dropdown-item" href="products.php?product=paper-packaking">Paper Packaking Group</a>
                <a class="dropdown-item" href="products.php?product=advertisement">Advirtisement Group</a>
                <a class="dropdown-item" href="products.php?product=carrier-bag">Nylon Bag Group</a>
              </div>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="our_reference.php">References</a>
            </li>
            <li class="nav-item">
